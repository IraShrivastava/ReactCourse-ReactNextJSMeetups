...
// EXTERNAL MODULE: ./mongocred.js
var mongocred = __webpack_require__("7r5I");
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://' + mongocred["a" /* mongo */].userName + ':' + mongocred["a" /* mongo */].pass + '@cluster0.9auyg.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
